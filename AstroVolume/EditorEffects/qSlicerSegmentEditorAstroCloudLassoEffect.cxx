...
qSlicerSegmentEditorAstroCloudLassoEffectPrivate::qSlicerSegmentEditorAstroCloudLassoEffectPrivate(qSlicerSegmentEditorAstroCloudLassoEffect& object)
  ...
  , ThresholdSlicerLabel(NULL)
  , ThresholdSlicerWidget(NULL)
  , distance(0.)
{
  this->Normals[0] = 0.;
  this->Normals[1] = 0.;
...
void qSlicerSegmentEditorAstroCloudLassoEffectPrivate::init()
{
  ...
  this->ThresholdSlicerLabel = new QLabel("Threshold value: ");
  q->addOptionsWidget(this->ThresholdSlicerLabel);
...
void qSlicerSegmentEditorAstroCloudLassoEffectPrivate::onUnitNodeIntensityChanged(vtkObject *sender)
{
  ...
  this->ThresholdSlicerWidget->spinBox()->setDecimals(unitNodeIntensity->GetPrecision());
}
...
void qSlicerSegmentEditorAstroCloudLassoEffect::updateGUIFromMRML()
{
  ...
  d->ThresholdSlicerLabel->setEnabled(!eraseMode);
  ...
  double range[2];
  this->parameterSetNode()->GetMasterVolumeIntensityMaskRange(range);
  range[0] = ThresholdValue;
  this->parameterSetNode()->SetMasterVolumeIntensityMaskRange(range);
